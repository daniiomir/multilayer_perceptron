...
if __name__ == '__main__':
    ...
    lr = LogisticRegression(random_state=args['seed'], solver='sag', max_iter=10000).fit(X_train, np.argmax(y_train, axis=1))
    mlp = MLPClassifier(random_state=args['seed'], max_iter=10000, hidden_layer_sizes=(20, 50)).fit(X_train, np.argmax(y_train, axis=1))
